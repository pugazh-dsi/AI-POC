...
export default function ChatWindow({
  ...
  return (
    // The transcript is capped and centred on the same 4xl column as the
    // composer, so wide screens get breathing room on both sides instead of
    // stretching a message the full width of the pane.
    <div className="flex-1 overflow-y-auto px-6 md:px-10 lg:px-16 py-6 bg-gray-50">
